...
if(filter_input(INPUT_GET, 't')) {
    $page_type = cleanvar(filter_input(INPUT_GET, 't'));
}
...
elseif($page_type == 'srv') { ## if edit a server page ##
    ...
    $server_id = cleanvar(filter_input(INPUT_GET, 'id'));
    if($server_id == '') {
...
elseif($page_type == 'add') : ?>
    ...
    <div class="card-body">
        ...
        <div class="col justify-center">
            ...
            <div class="form-group row">
                <label class="col-sm-4 col-form-label" for="rcon-pass">Mapcycle URL <span style="font-size:small">(link from outside)<span></label>
                <div class="col-sm-8">
                    <input class="form-control" type="text" name="mapcycleurl" id="mapcycleurl" maxlength="255" />
                </div>
            </div>  
        </div>
...
<?php 
elseif($page_type == 'srv') : /* if edit server page */ ?>
    ...
    <div class="card-body">
        ...
        <div class="col justify-center">
            ...
            <div class="form-group row">
                <label class="col-sm-4 col-form-label" for="mapcycleurl">Mapcycle URL <span style="font-size:small">(link from outside)<span></label>
                <div class="col-sm-8">
                    <input class="form-control" type="text" name="mapcycleurl" id="mapcycleurl" value="<?php echo $server['mapcycleurl']; ?>" maxlength="255" />
                </div>
            </div>    	  							
        </div>
        ...
        <button class="btn btn-primary float-right" type="submit" name="server-settings-sub" value="Server Settings">Save Settings</button>
