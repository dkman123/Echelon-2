<?php
if (!empty(filter_input(INPUT_SERVER, 'SCRIPT_FILENAME')) && "inc.php" == basename(filter_input(INPUT_SERVER, 'SCRIPT_FILENAME'))) {
...
require_once 'classes/members-class.php'; // class to preform all B3 DB related actions
