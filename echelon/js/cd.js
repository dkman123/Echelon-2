...
function editBanBox(thisItem) {
    ...
    console.log("colorbox doesn't work any more");
    alert("colorbox doesn't work any more, so you need to delete then add a new penalty for now");
    //window.location = ("inc/cd/editban.php?banid=" + ban_id);
}
