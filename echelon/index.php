        ...
        <div class="container">
            ...
            <div class="row mt-4 my-4">
                <div class="col-md-4">
                    ...
                    <!--You shall now be able to use Echelon . For tech-minded people: I've used Bootstrap 4 to completely redesign Echelon.-->
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <p>
                      <ul>
                          <li>Live permban, meaning player will be banned instantly if he is online on our servers </li>
                          <li>Chatlogger &amp; chatting with clients online and checking chatlogs</li>
                      </ul>
                    </p>
                </div>
            </div>
