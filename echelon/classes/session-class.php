<?php
if (!empty(filter_input(INPUT_SERVER, 'SCRIPT_FILENAME')) && 'session-class.php' == basename(filter_input(INPUT_SERVER, 'SCRIPT_FILENAME'))) {
...
class Session {
    ...
    static public function logout() {
        ...
        if (null !== filter_input(INPUT_COOKIE, session_name())) {
    ...
    static function getFinger() {
        $user_agent = filter_input(INPUT_SERVER, 'HTTP_USER_AGENT'); // get browser name from user
