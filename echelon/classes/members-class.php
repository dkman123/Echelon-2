<?php
if (!empty(filter_input(INPUT_SERVER, 'SCRIPT_FILENAME')) && 'members-class.php' == basename(filter_input(INPUT_SERVER, 'SCRIPT_FILENAME'))) {
...
class member {
     ...
     *
     * @param string $time - time format (default is available)
     */
    ...
    /**
     * Using a user's password this function sees if the user input the right password for action verification
     *
    ...
    /**
     * Checks if the password is strong enough - uses multiple checks
     *
     * @param string $password - the password you wish to check
     * @param int $min_pw_len - minimum length a password can be
