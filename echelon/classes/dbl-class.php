...
class DbL {
     ...
     * @param string $type - type of query this is 
     */
    private function query($sql, $fetch = true, $type = 'select') {
        ...
        try {
            ...
            $this->dbl_error = true; // there is an error
            if($this->error_on) { // if detailed errors work
                $this->error_msg = "MySQL Query Error (#". $this->mysql->errno ."): ". $this->mysql->dbl_error;
            }
            //else {
    ...
    ****************************/
     ...
     *
     * @param string $cat - category of settings to retrieve
     * @return array
     */
     ...
     * @param string $value_type - whether the value provided is a string or an int
     * @return bool
     */
     ...
     *
     * @param string $ip - current IP address to update DB records
     ...
     *
     * @param string $ip - IP address of current user to check of current BL
     * @return bool
     */
    ...
    /**
     * Find the users password salt by using their id
     *
     * @param int $user_id
     * @return string/false
     */
    ...
    /**
     * Checks that a users password is correct (needed to verify user identity with edit me page)
     *
     ...
     * @param string $key_expire - length in days of how long a key is active for
     * @return bool
     */
