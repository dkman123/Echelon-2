<?php
	...
	if(filter_input(INPUT_POST, 't') == 'install') :

            ## find the Echelon directory ##
            $install_dir = filter_input(INPUT_SERVER, 'SCRIPT_NAME');
            ...
            $db_pass = cleanvar(filter_input(INPUT_POST, 'db-pass'));
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="wrap">
            ...
            <?php if(filter_input(INPUT_GET, 't') == 'done') : ?>
