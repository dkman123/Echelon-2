...
if(!filter_input(INPUT_POST, 'settings-sub')) :
...
## Get Vars ##
$f_name = cleanvar(filter_input(INPUT_POST, 'name'));
$f_limit_rows = cleanvar(filter_input(INPUT_POST, 'limit_rows'));
$f_min_pw_len = cleanvar(filter_input(INPUT_POST, 'min_pw_len'));
$f_user_key_expire = cleanvar(filter_input(INPUT_POST, 'user_key_expire'));
$f_email = cleanvar(filter_input(INPUT_POST, 'email'));
$f_admin_name = cleanvar(filter_input(INPUT_POST, 'admin_name'));
$f_https = cleanvar(filter_input(INPUT_POST, 'https'));
$f_allow_ie = cleanvar(filter_input(INPUT_POST, 'allow_ie'));
$f_time_format  = cleanvar(filter_input(INPUT_POST, 'time_format'));
$f_time_zone = cleanvar(filter_input(INPUT_POST, 'time_zone'));     
$f_email_header = cleanvar(filter_input(INPUT_POST, 'email_header'));
$f_email_footer = cleanvar(filter_input(INPUT_POST, 'email_footer'));
$f_newsfeed = filter_input(INPUT_POST, 'newsfeed');
$f_pw_req_level = cleanvar(filter_input(INPUT_POST, 'pw_req_level'));
$f_pw_req_level_group = cleanvar(filter_input(INPUT_POST, 'pw_req_level_group'));
