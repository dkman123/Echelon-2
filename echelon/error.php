...
<div class="col-md-6 error-msg error my-3 mx-auto">
    ...
    <?php 
        if(filter_input(INPUT_GET, 't') == 'locked') {
        ...
        } elseif(filter_input(INPUT_GET, 't') == 'ie') {
        ...
        } elseif(filter_input(INPUT_GET, 't') == 'plug') {
